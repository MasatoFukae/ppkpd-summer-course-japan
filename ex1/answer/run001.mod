...
$DATA /data/PPKPDseminar2025/final/ex1/excercise/01_data/pkpd02.csv IGNORE=@ IGNORE(DVID.EQ.1) IGNORE(BSLFL.EQ.1)
...
RL = EMAX*(CP**HILL)/(EC50**HILL + CP**HILL)
IH = IMAX * IL6AUC / ((IC50/(KPRIM**(NDOSE-1))) + IL6AUC)

DADT(4) = IL6
DADT(5) = KDEG*IL6BASE + RL*(1-IH) -KTR*A(5)
DADT(6) = KTR*A(5) - KTR*A(6)
DADT(7) = KTR*A(6) - KTR*A(7)
DADT(8) = KTR*A(7) - KTR*A(8)
DADT(9) = KTR*A(8) - KTR*A(9)
DADT(10) = KTR*A(9) - KTR*A(10)
DADT(11) = KTR*A(10) - KDEG*A(11)
